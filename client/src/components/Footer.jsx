        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              <a href="mailto:zsportq@gmail.com" className='text-blue-400 hover:underline' data-discover="true">zsportq@gmail.com</a>
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <PhoneIcon className='mr-2' />
              <a href="tel:+48 576 231 531" className='text-blue-400 hover:underline' data-discover="true">+48 576 231 531</a> 
            </p>
          </div>
        </div>
      </div>
